...
// MAILING 
$mail = 'dodomon61.nb@mail.com'; // Déclaration de l'adresse de destination.
...
$header = "From: \"WeaponsB\"<dodomon61@mail.com>".$passage_ligne;
$header.= "Reply-to: \"WeaponsB\" <dodomon61@mail.com>".$passage_ligne;
